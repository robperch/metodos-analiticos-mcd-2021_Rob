...
- El punto es ver el grado de modularidad para ver si podrían haber grupos.
  - Aquí la idea es primero contar todas las aristas.
  - Después contar solo las aristas que conectan dentro de los grupos.
...
- Si este cociente es 1 entonces es una red muy cohesiva.
  - Se pueden separar muy bien lo grupos.
...
- Aquí podemos ver la adyacencia obsrvando patrones de 1's juntos.
- Esta matriz está arreglada muy bonita para mostrar el patrón.
- En la vida real no vamos a ver el patrón tan claro, pero podemos reordenar para intentar encontrar.
...
- Podemos hacer algo similar a la prueba de hipótesis.
  - Cortamos todas las aristas de los nodos.
  - Simulamos conexiones aleatorias entre todos los nodos.
  - Calculamos la modularidad.
  - Comparamos este valor con la red original.
...
- Hay que tener cuidado de redes que pueden sugerir ser muy modulares pero en realidad no lo son.
