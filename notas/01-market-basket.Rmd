...
#### Hay que notar que obtenemos una matriz rala. 
#### No es la mejor manera de presentar los datos.
#### La forma correcta podría ser guardar los datos en formato "long".
#### Pueden haber combinaciones clásicas de hasta 4 ingredientes que funcionen.
...
ap_srep_1 <- subset(ap_srep, size(ap_srep) == 1)

sort(ap_srep_1, by="support") %>%
  head %>%
  DATAFRAME
